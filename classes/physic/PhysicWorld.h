...
#include "../buffers/TextureQuadBuffer.h"
#include "PhysicQuad.h"
#include "ContactListener.h"

class MPhysicWorld {
private:
	MTextureQuadBuffer QuadBuffer;
...
public:
	MPhysicWorld();
	bool Create(float inGravity, float inTimeStep, int inVelocityIterations, int inPositionIterations, float inScale, unsigned int Id);
	void Step();
